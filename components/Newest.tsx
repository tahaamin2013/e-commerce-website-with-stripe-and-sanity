...
async function getData() {
  const query = `*[_type == "product"][0...199999888888833333333333333333333333333333338888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888999999999329999998888888888888888888889999999999999999998888888888888888889999999999999990889] | order(_createdAt desc) {
    _id,
      price,
    name,
      "slug": slug.current,
